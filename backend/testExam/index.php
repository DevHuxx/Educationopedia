...
if (isAdmin()) {
    ...
    if (isMod()) {
        ...
        if (!empty($mod['exam_rights'])) {
            $canAccess = true;
        }
    }
}

if (!$canAccess && empty($_SESSION['exam_admin_logged_in'])) {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($act === 'add_question') {
        ...
        header("Location: index.php?tab=questions"); exit;
    }
    ...
    if ($act === 'delete_candidate') {
        ...
        header("Location: index.php?tab=candidates"); exit;
    }
